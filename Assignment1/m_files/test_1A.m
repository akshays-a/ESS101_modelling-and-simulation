...
%Generalized cor-ordinates for the system are defined as following
q = [P1; theta; phi];                                                       

%First-order derivate of the position vector of helicopter
P1Dot = [p11Dot ; p12Dot ; p13Dot];                                          

%First-order derivate of the gernerailzed co-ordinate system
...
%derivative of position of helicopter with q
dP1dq_Transpose = jacobian(P1,q)';

%Amount of work produced on the system when moving the generalized coordinates
Q = dP1dq_Transpose * u;

%When the equations are arranged in the form: dt_dLdqDot - dLdq = Q
